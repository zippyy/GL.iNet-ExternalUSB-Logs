...
MODEM_LOG_PATTERN="${MODEM_LOG_PATTERN:-modem|quectel|mbim|rmt_storage|modem_fs|ql_ril|ql_sdk_api|diag_lib|nr5g|3gpp}"
...
detect_storage_mount() {
    ...
    # 2) Optional autodetect for preferred USB/SD paths.
    ...
    # 3) Fallback: scan /proc/mounts for common USB/SD block devices.
